  ...
  Widget build(BuildContext context) {
    return GetX(
        ...
        builder: (controller){
          ...
          List sportsChannels = controller.channel.where((channel) => channel['cat'] == 'sports').toList();
          List movieChannels = controller.channel.where((channel) => channel['cat'] == 'movie').toList();
